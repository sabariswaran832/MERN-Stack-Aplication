...
const EmployeeList = () => {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        const response = await axios.post('https://mern-stack-aplication.onrender.com/app/getUserData', {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://mern-stack-aplication.onrender.com/app/deleteUserData/${id}`);
